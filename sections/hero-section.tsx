...
export function HeroSection() {
  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-x-hidden px-6 pt-24 pb-8 sm:px-8 sm:pt-28">
      <HeroScene />
      <div
      ...
      <div className="relative mx-auto w-full max-w-6xl xl:max-w-6xl">
        <div className="grid grid-cols-1  sm:mt-6 mt-0 items-center gap-12 lg:grid-cols-12 lg:gap-y-12 lg:gap-x-16 xl:gap-x-24">
          ...
          <div className="order-1 flex  w-full justify-center overflow-visible lg:order-2 lg:col-span-5 lg:justify-end">
            <motion.div
              initial={{ opacity: 0, scale: 0.94, y: 16 }}
              animate={{ opacity: 1, scale: 1, y: 0 }}
              transition={{ duration: 0.65, delay: 0.15, ease: [0.22, 1, 0.36, 1] }}
              className="relative h-[min(420px,68vw)] w-full max-w-[300px] overflow-visible sm:h-[460px] sm:max-w-[340px] lg:h-[min(500px,54vh)] lg:max-w-[min(400px,100%)] lg:pt-6 xl:h-[520px] xl:max-w-[min(420px,100%)]"
            >
              ...
              <figure className="pointer-events-none absolute bottom-0 left-1/2 z-20 w-[min(122%,26rem)] -translate-x-1/2 -top-11 sm:w-[min(128%,28rem)] sm:-top-14">
                <Image
                  src={heroPortraitSrc}
                  alt="Ghulam Mustafa — Full Stack MERN Developer"
                  fill
                  className="object-cover object-[center_20%] sm:object-[center_16%]"
